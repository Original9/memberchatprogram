               ...
               <form id="frm" name="frm" action="boardUpdate.do" method="post"
                  ...
                  <div>
                     ...
                     <div style="width:400px">
                        <input class="btn btn-primary" id="update" name="update" type="button" value="수정" onclick="checkBoard()"> &nbsp;&nbsp; 
                        <input class="btn btn-primary" type="button" id="reset" name="reset" onclick="reset1()" value="초기화">
