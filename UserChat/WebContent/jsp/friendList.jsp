			...
			<tbody>
				...
				<c:forEach items="${list }" var="dto">
					<tr>
						...
						<td style="width: 20px"><button class="btn btn-primary pull-center" onclick="findFunction()">메세지 보내기</button></td>
						<td style="width: 20px"><button class="btn btn-primary pull-center" onclick="findFunction()">친구 삭제</button></td>
					</tr>				
				</c:forEach>				
